  ...
  return (
    <div className='space-y-4'>
        <div>
            ...
            <p className='text-sm text-gray-500'> Add your techinical and soft skills </p>
        </div>
        ...
        <div className='bg-blue-50 p-3 rounded-lg'>
            ...
            Add 8-12 relevent skills. Include both technical skills (programming languages, tools) and soft skills (leadership, communication). </p>
        </div>
    </div>
  )
}
