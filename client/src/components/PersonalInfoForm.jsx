import { BriefcaseBusiness, MapPin, User, Mail, Phone , Globe } from 'lucide-react'
    ...
    <div>
      ...
      <div className='flex items-center gap-2'>
        <label>
            ...
            <input type="file" accept='image/jpeg' className='hidden' onChange={(e) => handleChange("image",e.target.files[0])}/>
        </label>
